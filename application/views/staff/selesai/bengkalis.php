...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('staff/selesai/cetak_bengkalis')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
    ...
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <a href="<?php echo base_url('staff/selesai/gambar/'.$bengkalis->id) ?>" class="btn btn-success btn-xs"><i class="fa fa-image"></i>Gambar</a>
                    <a href="<?php echo base_url('staff/selesai/edit/'.$bengkalis->id) ?>" class="btn btn-warning btn-xs">
                    <i class="fa fa-edit"></i> Edit</a>
                    <?php 
                        $gambar     = $this->data_model->detail_delete_gambar($bengkalis->id);
                        if($bengkalis->ttd != null && $gambar != null) { ?>
                            <a href="<?php echo base_url('staff/selesai/cetak_data/'.$bengkalis->id) ?>" class="btn btn-info btn-xs" target="_blank">
