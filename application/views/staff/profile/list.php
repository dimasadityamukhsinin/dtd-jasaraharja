...
// Form Open
echo form_open_multipart(base_url('staff/profile'), 'class="form-horizontal"');


?>

<div class="form-group">
    <label class="col-md-2 control-label">Nama Staff</label>
    <div class="col-md-5">
        <input type="text" name="nama" class="form-control" placeholder="Nama Staff" value="<?php echo $profile->nama ?>" required>
    </div>
</div>
