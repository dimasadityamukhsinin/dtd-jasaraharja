<div class="row">
    ...
    <script>
        $(document).ready(function(){
            ...
            function show_total(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_total");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
                    success : function(total_data){
                        var html = '';
                            html += '<div class="small-box bg-light-blue">' +
                                      ...
                                      '</div>' +
                                      '<a href="<?php echo base_url('staff/total_data') ?>" class="small-box-footer">' +
                                        "Selengkapnya " + 
            ...
            function show_belum(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_belum");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
                        ...
                        var html = '';
                            html += '<div class="small-box bg-red">' +
                                      ...
                                      '<div class="icon">' +
                                          '<i class="ion ion-stats-bars">' + '</i>' +
                                      '</div>' +
                                      '<a href="<?php echo base_url('staff/belum_diproses') ?>" class="small-box-footer">' +
                                        "Selengkapnya " + 
                                       '<i class="fa fa-arrow-circle-right">' + '</i>' + '</a>' +
                                    '</div>';
            ...
            function show_sudah(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_sudah");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
                        ...
                        var html = '';
                            html += '<div class="small-box bg-orange">' +
                                      ...
                                      '<div class="icon">' +
                                          '<i class="ion ion-stats-bars">' + '</i>' +
                                      '</div>' +
                                      '<a href="<?php echo base_url('staff/sudah_diproses') ?>" class="small-box-footer">' +
                                        "Selengkapnya " + 
                                       '<i class="fa fa-arrow-circle-right">' + '</i>' + '</a>' +
                                    '</div>';
            ...
            function show_selesai(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_selesai");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
                        ...
                        var html = '';
                            html += '<div class="small-box bg-green">' +
                                      ...
                                      '<div class="icon">' +
                                          '<i class="ion ion-stats-bars">' + '</i>' +
                                      '</div>' +
                                      '<a href="<?php echo base_url('staff/selesai') ?>" class="small-box-footer">' +
                                        "Selengkapnya " + 
                                       '<i class="fa fa-arrow-circle-right">' + '</i>' + '</a>' +
                                    '</div>';
            ...
            function show_pekanbaru(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_pekanbaru");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_dumai(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_dumai");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_siak(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_siak");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_rohul(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_rohul");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_rohil(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_rohil");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_pelalawan(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_pelalawan");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_kuansing(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_kuansing");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_meranti(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_meranti");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_kampar(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_kampar");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_inhu(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_inhu");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_inhil(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_inhil");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
            ...
            function show_bengkalis(){
                $.ajax({
                    url   : '<?php echo base_url("staff/dashboard/get_bengkalis");?>',
                    type  : 'GET',
                    async : true,
                    dataType : 'json',
