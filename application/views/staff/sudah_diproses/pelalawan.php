...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('staff/sudah_diproses/cetak_pelalawan')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
    ...
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <a href="<?php echo base_url('staff/sudah_diproses/edit/'.$pelalawan->id) ?>" class="btn btn-warning btn-xs">
