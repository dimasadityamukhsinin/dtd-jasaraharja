...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('staff/sudah_diproses/cetak_siak')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
    ...
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <a href="<?php echo base_url('staff/sudah_diproses/edit/'.$siak->id) ?>" class="btn btn-warning btn-xs">
