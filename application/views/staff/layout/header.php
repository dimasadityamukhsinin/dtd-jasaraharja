              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url('staff/profile') ?>" class="btn btn-default btn-flat">Profile</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo base_url('login/logout')?>" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                    <div>
                      <a href="<?php echo base_url('staff/profile/password') ?>" class="btn btn-default btn-flat btn-md">Ubah Password</a>
                    </div>
                  </li>
                </ul>
              </li>
