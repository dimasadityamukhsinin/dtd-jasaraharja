            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <?php 
                        ...
                        $data     = $this->data_model->detail_user($total_data->id);
                        if($total_data->ttd != null && $gambar != null && $data != null) { ?>
                        <a href="<?php echo base_url('petugas/total_data/cetak_data/'.$total_data->id) ?>" target="_blank" class="btn btn-info btn-sm" >
                        <i class="fa fa-print"></i> Cetak Data</a>
                    <?php } ?>
                    <?php 
                        $gambar     = $this->data_model->detail_delete_gambar($total_data->id);
                        if($total_data->ttd != null && $gambar != null) { ?>
                            <a href="<?php echo base_url('petugas/total_data/cetak_data/'.$total_data->id) ?>" class="btn btn-info btn-xs" target="_blank">
                            <i class="fa fa-print"></i> Cetak Data</a>
                    <?php } ?>
                </td>
            </tr>
