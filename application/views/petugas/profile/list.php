...
// Form Open
echo form_open_multipart(base_url('petugas/profile'), 'class="form-horizontal"');
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="nama" class="form-control" placeholder="Nama Petugas" value="<?php echo $profile->nama ?>" required>
    </div>
</div>
