<p class="pull-left">
    <div class="btn-group">
        <a href="<?php echo base_url('petugas/belum_diproses')?>" title="Kembali" class="btn btn-info btn-md">
...
// Form Open
echo form_open_multipart(base_url('petugas/belum_diproses/edit/'.$belum_diproses->id), 'class="form-horizontal"');
?>
