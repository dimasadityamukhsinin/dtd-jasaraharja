<p class="pull-left">
    <div>
        <a href="<?php echo base_url('petugas/selesai')?>" title="Kembali" class="btn btn-info btn-md">
...
//Form Open
echo form_open_multipart(base_url('petugas/selesai/uploadImage/'.$selesai->id), 'class="form-horizontal"');
?>
