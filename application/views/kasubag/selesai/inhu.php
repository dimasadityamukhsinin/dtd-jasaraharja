...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('kasubag/selesai/cetak_inhu')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
    ...
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <a href="<?php echo base_url('kasubag/selesai/gambar/'.$inhu->id) ?>" class="btn btn-success btn-xs"><i class="fa fa-image"></i>Gambar</a>
                    <a href="<?php echo base_url('kasubag/selesai/edit/'.$inhu->id) ?>" class="btn btn-warning btn-xs">
                    ...
                    <?php 
                        ...
                        if($inhu->ttd != null && $gambar != null) { ?>
                            <a href="<?php echo base_url('kasubag/selesai/cetak_data/'.$inhu->id) ?>" class="btn btn-info btn-xs" target="_blank">
