...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('kasubag/selesai/cetak_meranti')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <?php if($meranti->ttd != null) { ?>
                        <img src="<?php echo base_url('assets/upload/image/'.$meranti->ttd)?>" class="img img-responsive img-thumbnail" width="60">
                    <?php } ?>
                </td>
                <td>
                    <a href="<?php echo base_url('kasubag/selesai/gambar/'.$meranti->id) ?>" class="btn btn-success btn-xs"><i class="fa fa-image"></i>Gambar</a>
                    <a href="<?php echo base_url('kasubag/selesai/edit/'.$meranti->id) ?>" class="btn btn-warning btn-xs">
                    ...
                    <?php 
                        ...
                        if($meranti->ttd != null && $gambar != null) { ?>
                            <a href="<?php echo base_url('kasubag/selesai/cetak_data/'.$meranti->id) ?>" class="btn btn-info btn-xs" target="_blank">
