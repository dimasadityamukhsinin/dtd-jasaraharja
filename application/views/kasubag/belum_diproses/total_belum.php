    ...
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <a href="<?php echo base_url('kasubag/belum_diproses/edit/'.$total_belum->id) ?>" class="btn btn-warning btn-xs">
                    <i class="fa fa-edit"></i> Edit</a>
                    <?php 
                        $gambar     = $this->data_model->detail_delete_gambar($total_belum->id);
                        if($total_belum->ttd == null && $gambar == null) {
                            include('delete.php'); 
                        } ?>
                </td>
            </tr>
