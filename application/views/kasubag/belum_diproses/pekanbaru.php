...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('kasubag/belum_diproses/cetak_pekanbaru')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
    ...
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <a href="<?php echo base_url('kasubag/belum_diproses/edit/'.$pekanbaru->id) ?>" class="btn btn-warning btn-xs">
                    <i class="fa fa-edit"></i> Edit</a>
                    <?php 
                        $gambar     = $this->data_model->detail_delete_gambar($pekanbaru->id);
                        if($pekanbaru->ttd == null && $gambar == null) {
                            include('delete_pekanbarus.php'); 
                        } ?>
                </td>
            </tr>
            <?php } ?>
