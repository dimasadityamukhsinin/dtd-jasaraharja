        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <a href="<?php echo base_url('kasubag/sudah_diproses/cetak')?>" class="btn btn-warning btn-block" target="_blank">
                        <h5>CETAK SEMUA</h5>
                        </a>
                    </div>
                </div>
                <?php
                    // Form Open
                    echo form_open_multipart(base_url('kasubag/sudah_diproses/cetak_akhir'), 'class="form-horizontal"');
                ?>
                <p>
                    <div class="row">
                        <div class="col-lg-12">
