    ...
    <center>
        ...
        <center><table  class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <?php echo $inhu->nama_perusahaan ?>
                </td>
                <td>
                    <?php echo $inhu->pemilik ?>
                </td>
                <td>
                    <?php echo $inhu->alamat ?>
                </td>
                <td>
                    <?php echo $inhu->no_telpon ?>
                </td>
                <td>
                    <?php echo $inhu->nama_kapal ?>
                </td>
                <td>
                    <?php echo $inhu->kondisi ?>
                </td>
                <td>
                    <?php echo $inhu->jumlah_kapal ?>
                </td>
                <td>
                    <?php echo $inhu->status ?>
                </td>
                <td>
                    <?php echo $inhu->masa_awal ?>
                </td>
                
                <td>
                    <?php echo $inhu->masa_akhir ?>
                </td>
                <td>
                    Rp<?php echo number_format($inhu->tarif,'0',',','.') ?>
                </td>
                <td>
                    <?php echo $inhu->nama_regional ?>
                </td>
                <td>
                    <?php $date = date("Y-m-d");
