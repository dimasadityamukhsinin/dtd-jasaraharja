    ...
    <center>
        ...
        <center><table  class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <?php echo $total_data->nama_perusahaan ?>
                </td>
                <td>
                    <?php echo $total_data->pemilik ?>
                </td>
                <td>
                    <?php echo $total_data->alamat ?>
                </td>
                <td>
                    <?php echo $total_data->no_telpon ?>
                </td>
                <td>
                    <?php echo $total_data->nama_kapal ?>
                </td>
                <td>
                    <?php echo $total_data->kondisi ?>
                </td>
                <td>
                    <?php echo $total_data->jumlah_kapal ?>
                </td>
                <td>
                    <?php echo $total_data->status ?>
                </td>
                <td>
                    <?php echo $total_data->masa_awal ?>
                </td>
                
                <td>
                    <?php echo $total_data->masa_akhir ?>
                </td>
                <td>
                    Rp<?php echo number_format($total_data->tarif,'0',',','.') ?>
                </td>
                <td>
                    <?php echo $total_data->nama_regional ?>
                </td>
                <td>
                    <?php $date = date("Y-m-d");
