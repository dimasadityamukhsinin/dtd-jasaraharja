...
<body onload="print()">
    <center>
        ...
        <center><table  class="table table-bordered">
            ...
            <?php $no=1; foreach($cetak_akhir as $cetak_akhir) { ?>
            <tr>
            <td>
                    <?php echo $no++; ?>
                </td>
                ...
                <td>
                    <?php echo $cetak_akhir->masa_awal ?>
                </td>
                
                <td>
                    <?php echo $cetak_akhir->masa_akhir ?>
                </td>
                <td>
                    Rp<?php echo number_format($cetak_akhir->tarif,'0',',','.') ?>
                </td>
                <td>
