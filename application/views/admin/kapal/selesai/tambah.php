...
// Form Open
echo form_open_multipart(base_url('admin/kapal/selesai/tambah'), 'class="form-horizontal"');
?>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" class="form-control" placeholder="Status" value="SELESAI" readonly>
    </div>
</div>
