...
<body onload="print()">
    <?php $no=1; foreach($cetak_regional as $cetak_regional) { ?>
  ...
  border: 0.5px solid;">
        ...
        <p style="font-size: 17px">
            <table>
                <tr>
                    <td>
                        Pada Tanggal <?php echo $cetak_regional->tanggal_pelaksanaan ?> Kami
                    </td>
                    <td>
                        :
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        : <?php echo $cetak_regional->jabatan ?>
                    </td>
                </tr>
            </table>
            <br>
            ...
            Kapal :
                <table class="table borderless">
                    ...
                    <tr>
                        <td>
                            <center>
                                <img src="<?php echo base_url('assets/upload/image/'.$cetak_regional->ttd) ?>" width="59px">
                            </center>
                        </td>
                        <td></td>
                        <td>
                            <center>
                                <img src="<?php echo base_url('assets/upload/image/'.$cetak_regional->userttd) ?>" width="59px">
                            </center>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $cetak_regional->tanggal_pelaksanaan ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
