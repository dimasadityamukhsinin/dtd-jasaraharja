...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('admin/kapal/selesai/cetak_inhil')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <?php if($inhil->ttd != null) { ?>
                        <img src="<?php echo base_url('assets/upload/image/'.$inhil->ttd)?>" class="img img-responsive img-thumbnail" width="60">
                    <?php } ?>
                </td>
                <td>
                    <a href="<?php echo base_url('admin/kapal/selesai/gambar/'.$inhil->id) ?>" class="btn btn-success btn-xs"><i class="fa fa-image"></i>Gambar</a>
                    <a href="<?php echo base_url('admin/kapal/selesai/edit/'.$inhil->id) ?>" class="btn btn-warning btn-xs">
                    <i class="fa fa-edit"></i> Edit</a>
                    <?php 
                        $gambar     = $this->datakapal_model->detail_delete_gambar($inhil->id);
                        if($gambar == null) {
                    ...
                    <?php 
                        ...
                        if($inhil->ttd != null && $gambar != null) { ?>
                            <a href="<?php echo base_url('admin/kapal/selesai/cetak_data/'.$inhil->id) ?>" class="btn btn-info btn-xs" target="_blank">
