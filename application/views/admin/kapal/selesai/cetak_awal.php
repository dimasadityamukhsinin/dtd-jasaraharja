...
<body onload="print()">
    <center>
        ...
        <center><table  class="table table-bordered">
            ...
            <?php $no=1; foreach($cetak_awal as $cetak_awal) { ?>
            <tr>
                <td>
                    <?php echo $no++; ?>
                </td>
                <td>
                    <?php echo $cetak_awal->nopol ?>
                </td>
                <td>
                    <?php echo $cetak_awal->pemilik ?>
                </td>
                <td>
                    <?php echo $cetak_awal->alamat ?>
                </td>
                <td>
                    <?php echo $cetak_awal->no_telpon ?>
                </td>
                <td>
                    <?php echo $cetak_awal->kondisi ?>
                </td>
                <td>
                    <?php echo $cetak_awal->status ?>
                </td>
                <td>
                    <?php echo $cetak_awal->masa_awal ?>
                </td>
                
                <td>
                    <?php echo $cetak_awal->masa_akhir ?>
                </td>
                <td>
                    Rp<?php echo number_format($cetak_awal->tarif,'0',',','.') ?>
                </td>
                <td>
                    <?php echo $cetak_awal->nama_regional ?>
                </td>
                <td><?php $date = date("Y-m-d");
                        $akhir = $cetak_awal->masa_akhir;
                        ...
                        $oustanding =  $cetak_awal->tarif * $numBulan;
