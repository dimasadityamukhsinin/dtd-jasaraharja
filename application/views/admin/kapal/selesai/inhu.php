...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('admin/kapal/selesai/cetak_inhu')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
...
<div class="table-responsive">
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <tr>
            <td><?php echo $no++ ?></td>
                <td><?php echo $inhu->nama_perusahaan ?></td>
                ...
                <td><?php echo $inhu->nama_kapal ?></td>
                <td><?php echo $inhu->kondisi ?></td>
                <td><?php echo $inhu->jumlah_kapal ?></td>
                ...
                <td>
                    <a href="<?php echo base_url('admin/kapal/selesai/gambar/'.$inhu->id) ?>" class="btn btn-success btn-xs"><i class="fa fa-image"></i>Gambar</a>
                    <a href="<?php echo base_url('admin/kapal/selesai/edit/'.$inhu->id) ?>" class="btn btn-warning btn-xs">
                    <i class="fa fa-edit"></i> Edit</a>
                    <?php 
                        $gambar     = $this->datakapal_model->detail_delete_gambar($inhu->id);
                        if($gambar == null) {
                            include('delete_inhu.php');
                        } ?>
                    <?php 
                        $gambar     = $this->datakapal_model->detail_delete_gambar($inhu->id);
                        if($inhu->ttd != null && $gambar != null) { ?>
                            <a href="<?php echo base_url('admin/kapal/selesai/cetak_data/'.$inhu->id) ?>" class="btn btn-info btn-xs" target="_blank">
