...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('admin/selesai/cetak_inhu')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td>
                    <?php if($inhu->ttd != null) { ?>
                        <img src="<?php echo base_url('assets/upload/image/thumbs/'.$inhu->ttd)?>" class="img img-responsive img-thumbnail" width="60">
                    <?php } ?>
                </td>
                <td>
                    <a href="<?php echo base_url('admin/selesai/gambar/'.$inhu->id) ?>" class="btn btn-success btn-xs"><i class="fa fa-image"></i>Gambar</a>
                    <a href="<?php echo base_url('admin/selesai/edit/'.$inhu->id) ?>" class="btn btn-warning btn-xs">
                    ...
                    <?php 
                        ...
                        if($inhu->ttd != null && $gambar != null) { ?>
                            <a href="<?php echo base_url('admin/selesai/cetak_data/'.$inhu->id) ?>" class="btn btn-info btn-xs" target="_blank">
