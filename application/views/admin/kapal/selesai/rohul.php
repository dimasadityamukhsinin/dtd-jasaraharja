...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('admin/kapal/selesai/cetak_rohul')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
...
<div class="table-responsive">
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <tr>
            <td><?php echo $no++ ?></td>
                <td><?php echo $rohul->nama_perusahaan ?></td>
                ...
                <td><?php echo $rohul->nama_kapal ?></td>
                <td><?php echo $rohul->kondisi ?></td>
                <td><?php echo $rohul->jumlah_kapal ?></td>
                ...
                <td>
                    <?php if($rohul->ttd != null) { ?>
                        <img src="<?php echo base_url('assets/upload/image/'.$rohul->ttd)?>" class="img img-responsive img-thumbnail" width="60">
                    <?php } ?>
                </td>
                <td>
                    <a href="<?php echo base_url('admin/kapal/selesai/gambar/'.$rohul->id) ?>" class="btn btn-success btn-xs"><i class="fa fa-image"></i>Gambar</a>
                    <a href="<?php echo base_url('admin/kapal/selesai/edit/'.$rohul->id) ?>" class="btn btn-warning btn-xs">
                    <i class="fa fa-edit"></i> Edit</a>
                    <?php 
                        $gambar     = $this->datakapal_model->detail_delete_gambar($rohul->id);
                        if($gambar == null) {
                    ...
                    <?php 
                        ...
                        if($rohul->ttd != null && $gambar != null) { ?>
                            <a href="<?php echo base_url('admin/kapal/selesai/cetak_data/'.$rohul->id) ?>" class="btn btn-info btn-xs" target="_blank">
