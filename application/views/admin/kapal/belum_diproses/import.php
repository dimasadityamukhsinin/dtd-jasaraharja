      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <?php
                // Form Open
                echo form_open_multipart(base_url('admin/kapal/belum_diproses/import'), 'class="form-horizontal"');
            ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <a href="<?php echo base_url() ?>assets/excel/importexcel_kapal.xlsx" class="btn btn-warning btn-block">
