...
<div class="table-responsive">
    <table class="table table-bordered" id="example1">
        ...
        <tbody>
            ...
            <tr>
            <td><?php echo $no++ ?></td>
                <td><?php echo $total_belum->nama_perusahaan ?></td>
                ...
                <td><?php echo $total_belum->nama_kapal ?></td>
                <td><?php echo $total_belum->kondisi ?></td>
                <td><?php echo $total_belum->jumlah_kapal ?></td>
                ...
                <td><?php $date = date("Y-m-d");
                        ...
                        $total =  $total_belum->tarif * $numBulan;
                        $oustanding = $total_belum->jumlah_kapal * $total;
                        echo "Rp.", number_format($oustanding,'0',',','.');
                    ?>
                </td>
                <td>
                    <a href="<?php echo base_url('admin/kapal/belum_diproses/edit/'.$total_belum->id) ?>" class="btn btn-warning btn-xs">
