...
<p class="pull-right">
    <div class="btn-group ">
        <a href="<?php echo base_url('admin/kapal/belum_diproses/cetak_inhu')?>" title="Cetak" target="_blank" class="btn btn-success btn-lg">
        ...
        <tbody>
            ...
            <td><?php echo $no++ ?></td>
                ...
                <td><?php $date = date("Y-m-d");
                        ...
                        $total =  $inhu->tarif * $numBulan;
                        $oustanding = $inhu->jumlah_kapal * $total;
                        echo "Rp.", number_format($oustanding,'0',',','.');
                    ?>
                </td>
                <td>
                    <a href="<?php echo base_url('admin/kapal/belum_diproses/edit/'.$inhu->id) ?>" class="btn btn-warning btn-xs">
                    <i class="fa fa-edit"></i> Edit</a>
                    <?php include('delete_inhu.php') ?>
                </td>
            </tr>
            <?php } ?>
        </tbody>
