...
// Form Open
echo form_open_multipart(base_url('admin/kapal/belum_diproses/tambah'), 'class="form-horizontal"');
?>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="jumlah_kapal" class="form-control" placeholder="Jumlah Kapal" value="<?php echo set_value('jumlah_kapal') ?>" required>
    </div>
</div>
