    ...
    <center>
        ...
        <center><table  class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <?php echo $siak->nama_perusahaan ?>
                </td>
                <td>
                    <?php echo $siak->pemilik ?>
                </td>
                <td>
                    <?php echo $siak->alamat ?>
                </td>
                <td>
                    <?php echo $siak->no_telpon ?>
                </td>
                <td>
                    <?php echo $siak->nama_kapal ?>
                </td>
                <td>
                    <?php echo $siak->kondisi ?>
                </td>
                <td>
                    <?php echo $siak->jumlah_kapal ?>
                </td>
                <td>
                    <?php echo $siak->status ?>
                </td>
                <td>
                    <?php echo $siak->masa_awal ?>
                </td>
                
                <td>
                    <?php echo $siak->masa_akhir ?>
                </td>
                <td>
                    Rp<?php echo number_format($siak->tarif,'0',',','.') ?>
                </td>
                <td>
                    <?php echo $siak->nama_regional ?>
                </td>
                <td>
                    <?php $date = date("Y-m-d");
