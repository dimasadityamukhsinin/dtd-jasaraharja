<p class="pull-left">
    <div class="btn-group">
        <a href="<?php echo base_url('admin/kapal/belum_diproses')?>" title="Kembali" class="btn btn-info btn-md">
...
// Form Open
echo form_open_multipart(base_url('admin/kapal/belum_diproses/edit/'.$belum_diproses->id), 'class="form-horizontal"');
?>

<div class="form-group">
    <label class="col-md-2 control-label">Nama Perusahaan</label>
    <div class="col-md-5">
        <input type="text" name="nama_perusahaan" class="form-control" placeholder="Nama Perusahaan" value="<?php echo $belum_diproses->nama_perusahaan ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="nama_kapal" class="form-control" placeholder="Nama Kapal" value="<?php echo $belum_diproses->nama_kapal ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="number" name="jumlah_kapal" class="form-control" placeholder="Jumlah Kapal" value="<?php echo $belum_diproses->jumlah_kapal ?>" required>
    </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <select name="status" class="form-control">
        ...
        <option value="Sudah Diproses" <?php if($belum_diproses->status=="Sudah Diproses") { echo "selected"; } ?> >Sudah Diproses</option>
        <option value="Selesai" <?php if($belum_diproses->status=="Selesai") { echo "selected"; } ?> >Selesai</option>
    </select>
  </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="date" name="janji_bayar" class="form-control" placeholder="Janji Bayar" value="<?php echo $belum_diproses->janji_bayar ?>">
    </div>
</div>
