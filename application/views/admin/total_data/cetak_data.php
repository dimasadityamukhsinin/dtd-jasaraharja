            ...
            Bermotor :
                <table class="table borderless">
                    ...
                    <tr>
                        <td>
                            <center>
                                <img src="<?php echo base_url('assets/upload/image/'.$cetak_data->ttd) ?>" width="59px">
                            </center>
                        </td>
                        <td></td>
                        <td>
                            <center>
                                <img src="<?php echo base_url('assets/upload/image/'.$cetak_data->userttd) ?>" width="59px">
                            </center>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $cetak_data->tanggal_pelaksanaan ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
