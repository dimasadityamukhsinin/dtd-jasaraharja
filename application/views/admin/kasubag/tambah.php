...
// Form Open
echo form_open_multipart(base_url('admin/kasubag/tambah'), 'class="form-horizontal"');
?>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" class="form-control" placeholder="Level" value="KASUBAG" readonly>
    </div>
</div>
