        ...
        <p style="font-size: 17px">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        : <?php echo $cetak_datasemuapelaksanaan->nopol ?>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <br>
            Hasil Kegiatan<br>
            1. Status Kendaraan : <b><?php echo $cetak_datasemuapelaksanaan->kondisi ?></b><br>
            2. Tunggakan IWKBU periode <?php echo $cetak_datasemuapelaksanaan->masa_awal ?> s/d <?php echo $cetak_datasemuapelaksanaan->masa_akhir ?> Sebesar <?php $date = date("Y-m-d");
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3">
                                <center>
                                    <?php 
                                    $gambar = $this->data_model->gambar($cetak_datasemuapelaksanaan->data_id);
