...
class Total_data extends CI_Controller {
    ...
    public function cetak()
    {
        if($this->session->userdata('level') == '2') {
            ...
            $this->load->view('staff/total_data/cetak', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_data($id=null)
    {
        ...
        if($this->session->userdata('level') == '2') {
            ...
            $kepalacabang = $this->staff_model->cek_laporan();
            $konfigurasi = $this->konfigurasi_model->listing();
            ...
            $this->load->view('staff/total_data/cetak_data', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_akhir()
    {
        if($this->session->userdata('level') == '2') {
            ...
            $this->load->view('staff/total_data/cetak_akhir', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_tp()
    {
        if($this->session->userdata('level') == '2') {
            ...
            $this->load->view('staff/total_data/cetak_tp', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
