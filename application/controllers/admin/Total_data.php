...
class Total_data extends CI_Controller {
    ...
    public function cetak_akhir()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/total_data/cetak_akhir', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_tp()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/total_data/cetak_tp', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/total_data/cetak', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
