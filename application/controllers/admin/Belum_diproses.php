...
class Belum_diproses extends CI_Controller {
    ...
    public function hapus_semua()
    {
        ...
        if($this->session->userdata('level') == '1') {
            ...
            $this->data_model->hapus_semuabelum();
            $this->session->set_flashdata('sukses', 'Data telah dihapus');
            redirect(base_url('admin/belum_diproses'), 'refresh');
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function total_belum()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Menu Belum Diproses',
                            ...
                            'isi'   =>  'admin/belum_diproses/total_belum'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function pekanbaru()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kota Pekanbaru',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'pekanbaru'    =>  $pekanbaru,
                            'isi'   =>  'admin/belum_diproses/pekanbaru'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function dumai()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kota Dumai',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'dumai'    =>  $dumai,
                            'isi'   =>  'admin/belum_diproses/dumai'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function rohul()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kabupaten Rokan Hulu',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'rohul'    =>  $rohul,
                            'isi'   =>  'admin/belum_diproses/rohul'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function rohil()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kabupaten Rokan Hilir',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'rohil'    =>  $rohil,
                            'isi'   =>  'admin/belum_diproses/rohil'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function pelalawan()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kabupaten Pelalawan',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'pelalawan'    =>  $pelalawan,
                            'isi'   =>  'admin/belum_diproses/pelalawan'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function kuansing()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kabupaten Kuantan Singingi',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'kuansing'    =>  $kuansing,
                            'isi'   =>  'admin/belum_diproses/kuansing'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function kampar()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kabupaten Kampar',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'kampar'    =>  $kampar,
                            'isi'   =>  'admin/belum_diproses/kampar'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function inhil()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kabupaten Indragiri Hilir',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'inhil'    =>  $inhil,
                            'isi'   =>  'admin/belum_diproses/inhil'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function bengkalis()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(  'title' =>  'Total Belum Diproses Kabupaten Bengkalis',
                            ...
                            'konfigurasi'   =>  $konfigurasi,
                            'bengkalis'    =>  $bengkalis,
                            'isi'   =>  'admin/belum_diproses/bengkalis'
                        );
            $this->load->view('admin/layout/wrapper', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
    ...
    public function tambah()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $data = array(	'title' => 'Tambah Belum Diproses',
                            ...
                            'regional'  =>  $regional,
                            'konfigurasi'   =>  $konfigurasi,
                            'isi'      => 'admin/belum_diproses/tambah');
            $this->load->view('admin/layout/wrapper',$data,FALSE);
            //Masuk Database
            }else{
            $i = $this->input;   
    ...
    public function delete($id = null)
    {
        ...
        if($this->session->userdata('level') == '1') {
            ...
            if (!$data) {
                ...
                $belum_diproses     = $this->data_model->detail_delete($id);
    ...
    public function cetak()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_akhir()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_akhir', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_pekanbaru()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_pekanbaru', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_dumai()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_dumai', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_siak()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_siak', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_rohul()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_rohul', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_rohil()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_rohil', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_pelalawan()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_pelalawan', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_kuansing()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_kuansing', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_kampar()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_kampar', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_inhu()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_inhu', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_inhil()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_inhil', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
    ...
    public function cetak_bengkalis()
    {
        if($this->session->userdata('level') == '1') {
            ...
            $this->load->view('admin/belum_diproses/cetak_bengkalis', $data, false);
        }else{
            $this->session->set_flashdata('warning','Anda belum login');
            redirect(base_url('login'),'refresh');
        }
